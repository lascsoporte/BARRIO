    ...
    container.innerHTML = `
      ...
      <div class="admin-login fade-in">
        ...
        <div style="display:flex;flex-direction:column;gap:10px;">
          <input type="password" id="adminPass1" placeholder="Llave 1">
          <input type="password" id="adminPass2" placeholder="Llave 2">
          <input type="password" id="adminPass3" placeholder="Llave 3">
        </div>
  ...
  showLocalForm(data = null) {
    ...
    f.innerHTML = `
      <div class="admin-form">
        ...
        <div class="form-group"><label>Nombre</label><input id="fNombre" value="${data?.nombre || ''}"></div>
        <div class="form-group"><label>Dirección</label><input id="fDireccion" value="${data?.direccion || ''}"></div>
        <div class="form-row">
          <div class="form-group"><label>Apertura</label><input type="time" id="fApertura" value="${data?.horario_apertura || '08:00'}"></div>
          <div class="form-group"><label>Cierre</label><input type="time" id="fCierre" value="${data?.horario_cierre || '20:00'}"></div>
        </div>
        ...
        <div class="form-check"><input type="checkbox" id="fEfectivo" ${data?.acepta_efectivo !== 0 ? 'checked' : ''}><label for="fEfectivo">Acepta Efectivo</label></div>
        <div class="form-check"><input type="checkbox" id="fTarjeta" ${data?.acepta_tarjeta ? 'checked' : ''}><label for="fTarjeta">Acepta Tarjeta</label></div>
        <div style="background:var(--bg-light); padding:12px; border-radius:8px; margin-bottom:12px;">
          ...
          <div style="display:flex; gap:8px; margin-bottom:8px;">
            <input id="fMapUrl" placeholder="Pega el link aquí (largo o corto)" style="flex:1;">
          ...
          <div class="form-row" style="opacity:0.7; pointer-events:none;">
            <div class="form-group"><label>Latitud</label><input id="fLat" type="number" step="any" value="${data?.latitud || ''}"></div>
            <div class="form-group"><label>Longitud</label><input id="fLng" type="number" step="any" value="${data?.longitud || ''}"></div>
          </div>
        </div>
  ...
  async renderProductosTab(c) {
    ...
    c.innerHTML = `
      ...
      <div id="bulkForm" style="display:none; background:var(--bg-card); padding:16px; border-radius:12px; margin-bottom:16px;">
        ...
        <div class="form-group"><input type="file" id="bulkFile" accept=".xlsx, .xls, .csv"></div>
        <div class="btn-group" style="flex-direction:row;gap:8px;">
  ...
  showProdForm(locales, data = null) {
    ...
    f.innerHTML = `
      <div class="admin-form">
        ...
        <div class="form-group"><label>Tipo de Producto</label><input id="pNombre" value="${data?.nombre || ''}" placeholder="Ej: Arroz"></div>
        <div class="form-group"><label>Marca (Opcional)</label><input id="pMarca" value="${data?.marca || ''}" placeholder="Ej: Los Chinos"></div>
        <div class="form-row">
          <div class="form-group"><label>Precio ($)</label><input id="pPrecio" type="number" value="${data?.precio || ''}"></div>
        ...
        <div class="form-check"><input type="checkbox" id="pStock" ${data?.en_stock !== 0 ? 'checked' : ''}><label for="pStock">En Stock</label></div>
        <div class="btn-group" style="flex-direction:row;gap:8px;">
  ...
  showServForm(data = null) {
    ...
    f.innerHTML = `
      <div class="admin-form">
        ...
        <div class="form-group"><label>Categoría (Plural)</label><input id="sTipo" value="${data?.tipo || ''}" placeholder="Ej: GASFITERS"></div>
        <div class="form-group"><label>Nombre prestador</label><input id="sNombre" value="${data?.nombre_prestador || ''}"></div>
        <div class="form-group"><label>Teléfono</label><input id="sTelefono" value="${data?.telefono || ''}" placeholder="+569..."></div>
        <div class="btn-group" style="flex-direction:row;gap:8px;">
    ...
    c.innerHTML = `
      <div class="admin-form">
        ...
        <div class="form-group">
          ...
          <input type="text" id="confCarabineros" value="${config.tel_carabineros || '133'}" placeholder="Ej: 133">
        </div>
        <div class="form-group">
          <label>Bomberos</label>
          <input type="text" id="confBomberos" value="${config.tel_bomberos || '132'}" placeholder="Ej: 132">
        </div>
        <div class="form-group">
          <label>PDI</label>
          <input type="text" id="confPdi" value="${config.tel_pdi || '134'}" placeholder="Ej: 134">
        </div>
        <div class="form-group">
          <label>Ambulancia</label>
          <input type="text" id="confAmbulancia" value="${config.tel_ambulancia || '131'}" placeholder="Ej: 131">
        </div>
        <div class="form-group">
          <label>Seguridad Ciudadana</label>
          <input type="text" id="confSeguridad" value="${config.tel_seguridad || '1529'}" placeholder="Ej: 1529">
        </div>
  ...
  async renderSeguridadTab(c) {
    c.innerHTML = `
      <div class="admin-form">
        ...
        <div class="form-group"><label>Llave 1 Actual</label><input type="password" id="secOld1" placeholder="Llave 1 actual"></div>
        <div class="form-group"><label>Llave 2 Actual</label><input type="password" id="secOld2" placeholder="Llave 2 actual"></div>
        <div class="form-group"><label>Llave 3 Actual</label><input type="password" id="secOld3" placeholder="Llave 3 actual"></div>
        <h4 style="margin-top:15px; margin-bottom:8px; font-size:0.9rem;">Nuevas Claves</h4>
        <div class="form-group"><label>Nueva Llave 1</label><input type="password" id="secNew1" placeholder="Nueva llave 1"></div>
        <div class="form-group"><label>Nueva Llave 2</label><input type="password" id="secNew2" placeholder="Nueva llave 2"></div>
        <div class="form-group"><label>Nueva Llave 3</label><input type="password" id="secNew3" placeholder="Nueva llave 3"></div>
